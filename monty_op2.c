 ...
 */
void pop(stack_t **head_ref, unsigned int ln)
{
 ...
 * @ln: the line number of of the opcode.
 */
void swap(stack_t **head_ref, unsigned int ln)
{
	stack_t *tmp;
 ...
 */
void rotl(stack_t **head_ref, unsigned int ln)
{
	stack_t *tmp;
 ...
 * @ln: the line number of of the opcode (unused parameter).
 */
void rotr(stack_t **head_ref, unsigned int ln)
{
	stack_t *tmp;
 ...
 * @ln: the line number of of the opcode (unused parameter).
 */
void nop(stack_t **head_ref, unsigned int ln)
{
	UNUSED(head_ref);
	UNUSED(ln);
}
